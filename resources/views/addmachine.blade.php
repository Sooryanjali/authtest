                        ...
                        <form method="POST" enctype="multipart/form-data">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="cost" class="mt-1 block w-full border border-gray-300 rounded-md p-2" required>
                                </div>
                            ...
                            <div class="mt-4">
                                <button type="submit" class="bg-purple-500 hover:bg-[#5C3DC3] text-white font-bold py-2 px-4 rounded">
                                    Save
                                </button>
                                <button type="button" class="bg-gray-500 hover:bg-[#5C3DC3] text-white font-bold py-2 px-4 rounded">
                                    Add Specification
                                </button>
                            </div>
                        </form>
